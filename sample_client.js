...
async.series([
    ...
    function(callback) {
       the_session.read({nodeId: "ns=2;s=Studio.Tags.Application.MyVariable", attributeId: AttributeIds.Value}, (err, dataValue) => {
         if (!err) {
           console.log(" tag = ", dataValue.toString());
         }
         callback(err);
       });
    },
    ...
    function(callback) {
       const maxAge = 0;
       const nodeToRead = {
         nodeId: "ns=2;s=Studio.Tags.Application.MyVariable",
    ...
    function(callback) {
       ...
       const itemToMonitor = {
         nodeId: resolveNodeId("ns=2;s=Studio.Tags.Application.MyVariable"),
         attributeId: AttributeIds.Value
       };
